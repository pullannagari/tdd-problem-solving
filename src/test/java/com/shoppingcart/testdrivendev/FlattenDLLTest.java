...
public class FlattenDLLTest {
    ...
    */
    ...
    public void testFlattenDLL(){
        FlattenDLL flattenDLL = new FlattenDLL();
        int[] inputDLL = new int[]{1,2,3,4,5,6,0,0,0,7,8,9,10,0,0,11,12};
        int[] outputDLL = new int[]{};
        //Assertions.assertArrayEquals(outputDLL, flattenDLL.flattenSpecialDLL(inputDLL), "the arrays are equal");
    }
}
